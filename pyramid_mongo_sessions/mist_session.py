...
def MongoSessionFactoryConfig(**options):
    ...
    return implementer(ISession)(PyramidMongoSessionObject)
...
def session_factory_from_settings(settings):
    ...
    return MongoSessionFactoryConfig(**options)
